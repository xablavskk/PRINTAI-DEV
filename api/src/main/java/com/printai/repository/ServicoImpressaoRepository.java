...
public interface ServicoImpressaoRepository extends JpaRepository<ServicoImpressao, Long> {
    ...
    @Query("SELECT s FROM ServicoImpressao s LEFT JOIN FETCH s.maker LEFT JOIN FETCH s.tipo t LEFT JOIN FETCH t.tecnologias LEFT JOIN FETCH s.material")
    List<ServicoImpressao> findAll();

    @Query("SELECT s FROM ServicoImpressao s LEFT JOIN FETCH s.maker LEFT JOIN FETCH s.tipo t LEFT JOIN FETCH t.tecnologias LEFT JOIN FETCH s.material WHERE " +
